use crate::types::{Row, TableConfig, ColumnConfig, SpanningCellConfig, TableError};
...
pub fn validate_spanning_cell_configs(spanning_cells: &[SpanningCellConfig]) -> Result<(), TableError> {
...
pub fn check_spanning_cell_overlaps(spanning_cells: &[SpanningCellConfig]) -> Result<(), TableError> {
...
fn spanning_cells_overlap(cell1: &SpanningCellConfig, cell2: &SpanningCellConfig) -> bool {
    ...
    !(cell1_end_col <= cell2.col || cell2_end_col <= cell1.col ||
      cell1_end_row <= cell2.row || cell2_end_row <= cell1.row)
}

pub fn validate_table_data_with_config(rows: &[Row], config: &TableConfig) -> Result<(), TableError> {
