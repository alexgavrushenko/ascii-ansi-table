...
mod tests {
    ...
    #[test]
    fn test_pad_string() {
        assert_eq!(pad_string("hello", 10, crate::types::Alignment::Left), "hello     ");
        assert_eq!(pad_string("hello", 10, crate::types::Alignment::Right), "     hello");
        assert_eq!(pad_string("hello", 10, crate::types::Alignment::Center), "  hello   ");
    }
